...
internal fun PictureWithRelations.toPictureLocalModelPictureWithRelations(): PictureLocalModel.PictureWithRelations {
    return PictureLocalModel.PictureWithRelations(
        picture = this.picture.toPictureLocalModel(),
        tags = this.tags.toTagLocalModel(),
        colors = this.colors.toColorLocalModel(),
    )
}

internal fun PictureLocalModel.PictureWithRelations.toPictureWithRelations(): PictureWithRelations {
    return PictureWithRelations(
        picture = this.picture.toPicture(),
